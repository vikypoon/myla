            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="{{url('admin/login/logout')}}">退出</a></dd>
                    </dl>
                </li>
            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('用户页面','{{url('admin/user/index')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户列表</cite></a>
                            </li>                       
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('管理员列表','{{url('admin/admin/index')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>管理员列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('角色列表','{{url('admin/role/index')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>角色列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('权限列表','{{url('admin/permission/index')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>权限列表</cite></a>
                            </li>
                        </ul>
